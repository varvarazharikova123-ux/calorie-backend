    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_level', models.DecimalField(choices=[(1.2, 'Сидячий образ жизни'), (1.375, 'Легкая активность (1-3 раза/нед)'), (1.55, 'Средняя активность (3-5 раз/нед)'), (1.725, 'Высокая активность (6-7 раз/нед)'), (1.9, 'Очень высокая активность (2 раза/день)')], decimal_places=3, max_digits=4)),
